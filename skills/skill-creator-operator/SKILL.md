...
description: Create better Agent-Skills with a premium first-use setup wizard pattern, minimal context bloat, and reusable scaffolding.
---

# Skill Creator Operator

This skill helps you create a new agent-skill that feel premium.
...
- `<skillsDir>/<slug>/config.json` (optional, if need)
